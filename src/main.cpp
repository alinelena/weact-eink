...
// atom ESP32 CS/SS=22,SCL(SCK)=23,SDA(MOSI)=19,BUSY=32,RST=25,DC=21
#define CS 22
#define MOSI 19
#define SCK  23
#define MISO  33 
...
GxEPD2_3C<GxEPD2_213_Z98c, GxEPD2_213_Z98c::HEIGHT> display(GxEPD2_213_Z98c(/*CS=5*/ CS, /*DC=*/ DC, /*RST=*/ RST, /*BUSY=*/ BSY)); // GDEY0213Z98 122x250, SSD1680
